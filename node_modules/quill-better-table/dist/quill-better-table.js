...
class quill_better_table_BetterTable extends Module {
  ...
  constructor(quill, options) {
    ...
    // Guard for different Quill versions where key may be numeric (8) or string ('Backspace')
    const backspaceKey = quill.keyboard.bindings['Backspace'] || quill.keyboard.bindings[8];
    if (Array.isArray(backspaceKey) && backspaceKey.length) {
      let thisBinding = backspaceKey.pop();
      backspaceKey.splice(0, 1, thisBinding);
    }
